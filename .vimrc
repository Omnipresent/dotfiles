...
set incsearch
set hlsearch
" searches should be case-sensitive only if they contain upper case
...
"find files easily. don't need this with command-t but since command-t fails
"often on ubuntu, I'm still keeping this around
